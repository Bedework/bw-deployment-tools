...
installing chef-solo.   The hope is that this will prove useful to deployers who start with an existing server (and so wouldn't have interest in vagrant).  Install chef-solo, git clone this package, then run chef-solo and the byshell.sh scriptand it may just do most of the work for you! 
